...
<td style="height: 23px; width: 361px;">Dimensions to be presented in rows of a DE table (concepts on y-axis)<br/>-&nbsp;[full specs](https://sis-cc.gitlab.io/dotstatsuite-documentation/using-dlm/custom-data-view/default-layout/)</td>
...
<td style="height: 23px; width: 361px;">Dimensions to be presented in columns of a DE table (concepts on x-axis)<br/>-&nbsp;[full specs](https://sis-cc.gitlab.io/dotstatsuite-documentation/using-dlm/custom-data-view/default-layout/)</td>
<td style="height: 23px; width: 185.891px;">-&nbsp;Dataflow, DSD<br/>-&nbsp;Dimension</td>
<td style="height: 23px; width: 44.1094px;"></td>
...
<td style="height: 23px; width: 361px;">Dimensions to be presented at the row section level of a DE table<br/>-&nbsp;[full specs](https://sis-cc.gitlab.io/dotstatsuite-documentation/using-dlm/custom-data-view/default-layout/)</td>
<td style="height: 23px; width: 185.891px;">-&nbsp;Dataflow, DSD<br/>-&nbsp;Dimension</td>
<td style="height: 23px; width: 44.1094px;"></td>
<td style="height: 23px; width: 106px;">-&nbsp;Attached to Dataflow or DSD: &lt;dimension Id&gt;,&lt;dimension Id &gt;,&hellip;<br/>-&nbsp;Attached to Dimension: &lt;blank&gt;</p>
</td>
...
<td style="height: 23px; width: 361px;">Indication that an Item in an Item Scheme is to be selected by default in the DE visualisation filter, or is pre-selected when queried<br/>-&nbsp;[full specs](https://sis-cc.gitlab.io/dotstatsuite-documentation/using-dlm/custom-data-view/default-selection/)</td>
...
<td style="height: 23px; width: 361px;">Indication that a component and/or its value (dimension, dimension value, attribute, attribute value) is hidden in a presentation<br/>-&nbsp;[full specs](https://sis-cc.gitlab.io/dotstatsuite-documentation/using-dlm/custom-data-view/not-displayed/)</td>
<td style="height: 23px; width: 185.891px;">-&nbsp;Item in an Item Scheme (e.g. code in a codelist)<br/>-&nbsp;Dataflow, DSD</td>
<td style="height: 23px; width: 44.1094px;"></td>
...
<td style="height: 23px; width: 361px;">Explicit indication of localised order of items in items schemes<br/>-&nbsp;[generic full specs](https://sis-cc.gitlab.io/dotstatsuite-documentation/using-dlm/custom-data-view/implicit-explicit-order)<br/>-&nbsp;[DE search facets specs](https://sis-cc.gitlab.io/dotstatsuite-documentation/using-de/searching-data/facets/#facet-items-ordered-by-explicit-order-annotation)</td>
...
<td style="height: 23px; width: 361px;">Indication of a localised link to an external resource associated to the annotated Dataflow<br/>-&nbsp;[full specs](https://sis-cc.gitlab.io/dotstatsuite-documentation/using-dlm/custom-data-view/external-resources/)</td>
<td style="height: 23px; width: 185.891px;">Dataflow</td>
...
<td style="height: 23px; width: 361px;">Increase the maximum length for textual attribute values<br/>-&nbsp;[full specs](https://sis-cc.gitlab.io/dotstatsuite-documentation/using-dlm/upload-structure/text-attribute-length/)</td>
...
<td style="height: 23px; width: 361px;">Indication that referential metadata can be uploaded to a related DSD where the METADATA annotation is defined<br/>-&nbsp;[full specs](https://sis-cc.gitlab.io/dotstatsuite-documentation/using-dlm/upload-data/upload-referential-metadata/)</td>
<td style="height: 23px; width: 185.891px;">DSD</td>
<td style="height: 23px; width: 44.1094px;"></td>
...
<td style="height: 23px; width: 361px;">Indication of localised boosted dataflows in the DE search results when ordered by relevance<br/>-&nbsp;[full specs](https://sis-cc.gitlab.io/dotstatsuite-documentation/using-de/searching-data/search-results/#result-boosting)</td>
<td style="height: 23px; width: 185.891px;">Dataflow</td>
...
<td style="height: 23.5px; width: 361px;">Indication that an attribute and its atribute value can be presented as a flag<br/>-&nbsp;[full specs](https://sis-cc.gitlab.io/dotstatsuite-documentation/using-de/viewing-data/preview-table/#display-of-additional-information)</td>
...
<td style="height: 23px; width: 361px;">Indication that an attribute and its attribute value can be presented as a note<br/>-&nbsp;[full specs](https://sis-cc.gitlab.io/dotstatsuite-documentation/using-de/viewing-data/preview-table/#display-of-additional-information)</td>
<td style="height: 23px; width: 185.891px;">Dataflow</td>
<td style="height: 23px; width: 44.1094px;"></td>
...
<td style="height: 23px; width: 361px;">List of dimensions (concept IDs) that are used to define the full unit of measure<br/>-&nbsp;[full specs](https://sis-cc.gitlab.io/dotstatsuite-documentation/using-de/viewing-data/preview-table/unit-of-measure/#underlying-data-model)</td>
...
<td style="height: 23px; width: 361px;">List of dimensions (concept IDs) to be displayed in a drilldown presentation<br/>-&nbsp;[full specs](https://sis-cc.gitlab.io/dotstatsuite-documentation/using-de/viewing-data/microdata-preview-table/#microdata-preview-table)</td>
<td style="height: 23px; width: 185.891px;">Dataflow, DSD</td>
<td style="height: 23px; width: 44.1094px;"></td>
...
<td style="height: 23px; width: 361px;">Denotes the concept that specifies if observations are at the drilldown level (instead of aggregate level)<br/>-&nbsp;[full specs](https://sis-cc.gitlab.io/dotstatsuite-documentation/using-de/viewing-data/microdata-preview-table/#microdata-in-the-stat-suite)</td>
<td style="height: 23px; width: 185.891px;">Dataflow, DSD</td>
<td style="height: 23px; width: 44.1094px;"></td>
...
<td style="height: 23px; width: 361px;">Indication that a DSD can support data with values for a frequency higher than daily (e.g. hours, minutes, seconds)<br/>-&nbsp;[full specs](https://sis-cc.gitlab.io/dotstatsuite-documentation/using-api/api-main-features/#support-of-high-frequency-time-periods-using-sdmx-annotation)</td>
<td style="height: 23px; width: 185.891px;">DSD</td>
<td style="height: 23px; width: 44.1094px;"></td>
<td style="height: 23px; width: 106px;"></td>
</tr>
...
<td style="height: 23px; width: 361px;">-&nbsp;if ID="obs_count" then current number of observations per dataflow<br/>-&nbsp;if ID="series_count" then number of time series series per dataflow<br/>-&nbsp;[full specs](https://sis-cc.gitlab.io/dotstatsuite-documentation/using-dlm/dlm_overview/#content-of-the-list)</td>
